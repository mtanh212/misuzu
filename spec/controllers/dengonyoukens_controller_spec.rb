...
RSpec.describe DengonyoukensController, type: :controller do
  ...
  describe "GET #edit" do
    it "assigns the requested dengonyouken as @dengonyouken" do
      dengonyouken = Dengonyouken.create! valid_attributes
      get :edit, {:id => dengonyouken.to_param}, valid_session
      expect(assigns(:dengonyouken)).to eq(dengonyouken)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Dengonyouken" do
        expect {
          post :create, {:dengonyouken => valid_attributes}, valid_session
      ...
      it "redirects to the created dengonyouken" do
        post :create, {:dengonyouken => valid_attributes}, valid_session
        expect(response).to redirect_to(Dengonyouken.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved dengonyouken as @dengonyouken" do
        post :create, {:dengonyouken => invalid_attributes}, valid_session
        expect(assigns(:dengonyouken)).to be_a_new(Dengonyouken)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested dengonyouken" do
        dengonyouken = Dengonyouken.create! valid_attributes
        put :update, {:id => dengonyouken.to_param, :dengonyouken => new_attributes}, valid_session
        dengonyouken.reload
      ...
      it "assigns the requested dengonyouken as @dengonyouken" do
        dengonyouken = Dengonyouken.create! valid_attributes
        put :update, {:id => dengonyouken.to_param, :dengonyouken => valid_attributes}, valid_session
        expect(assigns(:dengonyouken)).to eq(dengonyouken)
      end
      ...
      it "redirects to the dengonyouken" do
        dengonyouken = Dengonyouken.create! valid_attributes
        put :update, {:id => dengonyouken.to_param, :dengonyouken => valid_attributes}, valid_session
        expect(response).to redirect_to(dengonyouken)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the dengonyouken as @dengonyouken" do
        dengonyouken = Dengonyouken.create! valid_attributes
        put :update, {:id => dengonyouken.to_param, :dengonyouken => invalid_attributes}, valid_session
        expect(assigns(:dengonyouken)).to eq(dengonyouken)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested dengonyouken" do
      dengonyouken = Dengonyouken.create! valid_attributes
      expect {
        delete :destroy, {:id => dengonyouken.to_param}, valid_session
      }.to change(Dengonyouken, :count).by(-1)
    end
