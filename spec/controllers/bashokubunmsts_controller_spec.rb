...
RSpec.describe BashokubunmstsController, type: :controller do
  ...
  # Bashokubunmst. As you add validations to Bashokubunmst, be sure to
  ...
  # BashokubunmstsController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "GET #edit" do
    it "assigns the requested bashokubunmst as @bashokubunmst" do
      bashokubunmst = Bashokubunmst.create! valid_attributes
      get :edit, {:id => bashokubunmst.to_param}, valid_session
      expect(assigns(:bashokubunmst)).to eq(bashokubunmst)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Bashokubunmst" do
        expect {
          post :create, {:bashokubunmst => valid_attributes}, valid_session
      ...
      it "redirects to the created bashokubunmst" do
        post :create, {:bashokubunmst => valid_attributes}, valid_session
        expect(response).to redirect_to(Bashokubunmst.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved bashokubunmst as @bashokubunmst" do
        post :create, {:bashokubunmst => invalid_attributes}, valid_session
        expect(assigns(:bashokubunmst)).to be_a_new(Bashokubunmst)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested bashokubunmst" do
        bashokubunmst = Bashokubunmst.create! valid_attributes
        put :update, {:id => bashokubunmst.to_param, :bashokubunmst => new_attributes}, valid_session
      ...
      it "assigns the requested bashokubunmst as @bashokubunmst" do
        bashokubunmst = Bashokubunmst.create! valid_attributes
        put :update, {:id => bashokubunmst.to_param, :bashokubunmst => valid_attributes}, valid_session
        expect(assigns(:bashokubunmst)).to eq(bashokubunmst)
      end
    ...
    context "with invalid params" do
      it "assigns the bashokubunmst as @bashokubunmst" do
        bashokubunmst = Bashokubunmst.create! valid_attributes
        put :update, {:id => bashokubunmst.to_param, :bashokubunmst => invalid_attributes}, valid_session
        expect(assigns(:bashokubunmst)).to eq(bashokubunmst)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested bashokubunmst" do
      bashokubunmst = Bashokubunmst.create! valid_attributes
      expect {
        delete :destroy, {:id => bashokubunmst.to_param}, valid_session
      }.to change(Bashokubunmst, :count).by(-1)
    end
