...
RSpec.describe DengonsController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all dengons as @dengons" do
      ...
      expect(assigns(:dengons)).to eq([dengon])
    end
  end
  ...
  describe "GET #show" do
    it "assigns the requested dengon as @dengon" do
      dengon = Dengon.create! valid_attributes
      get :send_kairan_view, {:id => dengon.to_param}, valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested dengon as @dengon" do
      dengon = Dengon.create! valid_attributes
      get :edit, {:id => dengon.to_param}, valid_session
      expect(assigns(:dengon)).to eq(dengon)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Dengon" do
        expect {
          post :create, {:dengon => valid_attributes}, valid_session
      ...
      it "redirects to the created dengon" do
        post :create, {:dengon => valid_attributes}, valid_session
        expect(response).to redirect_to(Dengon.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved dengon as @dengon" do
        post :create, {:dengon => invalid_attributes}, valid_session
        expect(assigns(:dengon)).to be_a_new(Dengon)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested dengon" do
        dengon = Dengon.create! valid_attributes
        put :update, {:id => dengon.to_param, :dengon => new_attributes}, valid_session
        dengon.reload
      ...
      it "assigns the requested dengon as @dengon" do
        dengon = Dengon.create! valid_attributes
        put :update, {:id => dengon.to_param, :dengon => valid_attributes}, valid_session
        expect(assigns(:dengon)).to eq(dengon)
      end
      ...
      it "redirects to the dengon" do
        dengon = Dengon.create! valid_attributes
        put :update, {:id => dengon.to_param, :dengon => valid_attributes}, valid_session
        expect(response).to redirect_to(dengon)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the dengon as @dengon" do
        dengon = Dengon.create! valid_attributes
        put :update, {:id => dengon.to_param, :dengon => invalid_attributes}, valid_session
        expect(assigns(:dengon)).to eq(dengon)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested dengon" do
      dengon = Dengon.create! valid_attributes
      expect {
        delete :destroy, {:id => dengon.to_param}, valid_session
      }.to change(Dengon, :count).by(-1)
    end
