...
RSpec.describe KairanyokenmstsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested kairanyokenmst as @kairanyokenmst" do
      kairanyokenmst = Kairanyokenmst.create! valid_attributes
      get :send_kairan_view, {:id => kairanyokenmst.to_param}, valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested kairanyokenmst as @kairanyokenmst" do
      kairanyokenmst = Kairanyokenmst.create! valid_attributes
      get :edit, {:id => kairanyokenmst.to_param}, valid_session
      expect(assigns(:kairanyokenmst)).to eq(kairanyokenmst)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Kairanyokenmst" do
        expect {
          post :create, {:kairanyokenmst => valid_attributes}, valid_session
      ...
      it "redirects to the created kairanyokenmst" do
        post :create, {:kairanyokenmst => valid_attributes}, valid_session
        expect(response).to redirect_to(Kairanyokenmst.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved kairanyokenmst as @kairanyokenmst" do
        post :create, {:kairanyokenmst => invalid_attributes}, valid_session
        expect(assigns(:kairanyokenmst)).to be_a_new(Kairanyokenmst)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested kairanyokenmst" do
        kairanyokenmst = Kairanyokenmst.create! valid_attributes
        put :update, {:id => kairanyokenmst.to_param, :kairanyokenmst => new_attributes}, valid_session
      ...
      it "assigns the requested kairanyokenmst as @kairanyokenmst" do
        kairanyokenmst = Kairanyokenmst.create! valid_attributes
        put :update, {:id => kairanyokenmst.to_param, :kairanyokenmst => valid_attributes}, valid_session
        expect(assigns(:kairanyokenmst)).to eq(kairanyokenmst)
      end
      ...
      it "redirects to the kairanyokenmst" do
        kairanyokenmst = Kairanyokenmst.create! valid_attributes
        put :update, {:id => kairanyokenmst.to_param, :kairanyokenmst => valid_attributes}, valid_session
        expect(response).to redirect_to(kairanyokenmst)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the kairanyokenmst as @kairanyokenmst" do
        kairanyokenmst = Kairanyokenmst.create! valid_attributes
        put :update, {:id => kairanyokenmst.to_param, :kairanyokenmst => invalid_attributes}, valid_session
        expect(assigns(:kairanyokenmst)).to eq(kairanyokenmst)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested kairanyokenmst" do
      kairanyokenmst = Kairanyokenmst.create! valid_attributes
      expect {
        delete :destroy, {:id => kairanyokenmst.to_param}, valid_session
      }.to change(Kairanyokenmst, :count).by(-1)
    end
