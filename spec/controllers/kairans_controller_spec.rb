...
RSpec.describe KairansController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all kairans as @kairans" do
      ...
      expect(assigns(:kairans)).to eq([kairan])
    end
  end
  ...
  describe "GET #edit" do
    it "assigns the requested kairan as @kairan" do
      kairan = Kairan.create! valid_attributes
      get :edit, {:id => kairan.to_param}, valid_session
      expect(assigns(:kairan)).to eq(kairan)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Kairan" do
        expect {
          post :create, {:kairan => valid_attributes}, valid_session
      ...
      it "redirects to the created kairan" do
        post :create, {:kairan => valid_attributes}, valid_session
        expect(response).to redirect_to(Kairan.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved kairan as @kairan" do
        post :create, {:kairan => invalid_attributes}, valid_session
        expect(assigns(:kairan)).to be_a_new(Kairan)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested kairan" do
        kairan = Kairan.create! valid_attributes
        put :update, {:id => kairan.to_param, :kairan => new_attributes}, valid_session
        kairan.reload
      ...
      it "assigns the requested kairan as @kairan" do
        kairan = Kairan.create! valid_attributes
        put :update, {:id => kairan.to_param, :kairan => valid_attributes}, valid_session
        expect(assigns(:kairan)).to eq(kairan)
      end
      ...
      it "redirects to the kairan" do
        kairan = Kairan.create! valid_attributes
        put :update, {:id => kairan.to_param, :kairan => valid_attributes}, valid_session
        expect(response).to redirect_to(kairan)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the kairan as @kairan" do
        kairan = Kairan.create! valid_attributes
        put :update, {:id => kairan.to_param, :kairan => invalid_attributes}, valid_session
        expect(assigns(:kairan)).to eq(kairan)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested kairan" do
      kairan = Kairan.create! valid_attributes
      expect {
        delete :destroy, {:id => kairan.to_param}, valid_session
      }.to change(Kairan, :count).by(-1)
    end
